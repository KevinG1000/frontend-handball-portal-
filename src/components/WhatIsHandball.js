  ...
  return (
    <div className="what-is-handball">
      ...
      <ul>
        ...
        <li>Games are usually played to 21 points, finals are sometimes to 25 points.</li>
      </ul>
      ...
      <p>
        Explore some of the best handball courts in NYC in our{' '}
        <span
          onClick={() => handleNavigation('/where-to-play')}
          style={{ color: '#3498db', cursor: 'pointer', textDecoration: 'underline' }}
        >
          Where to Play
        </span>{' '}
        section and watch high-level play in our{' '}
        <span
